...
export default function Home() {
	...
	const handleExit = useCallback(() => setActiveMode(null), []);
		...
		<main className="min-h-screen bg-transparent p-8">
			...
			<div className="relative z-10 mx-auto max-w-5xl space-y-8">
				<header className="flex items-center justify-between rounded-xl border bg-background/60 px-6 py-5 backdrop-blur">
					<div>
						<h1 className="text-3xl font-bold tracking-tight">OpenArm 遥操作</h1>
					...
					<div className="flex items-center gap-3">
						{activeMode === null ? (
							<>
								...
								<Button size="lg" className="gap-2" onClick={handleEnterXR}>
